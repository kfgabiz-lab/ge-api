 ...
 *
 * @param content       현재 페이지 결과 목록(5개 소스 UNION 후 sort_ts DESC 정렬)
 ...
 * @param sourceCounts  소스별 검색 건수 — TECH_HUB/BLOG/PRESS/ARTICLE/EVENT 5키를 항상 포함(0건도 0으로 채움, LinkedHashMap 순서 고정).
