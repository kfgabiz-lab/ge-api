 ...
 * - 그룹(prdGrp-data) 1건 + 그 안의 제품(ms) 목록을 제품 상세(product-data)로 치환한 형태
...
public record FoProductGroupResponse(
        ...
        Long id,
        /** 그룹명 (prdGrpForm1.prdGrpNm) */
        String prdGrpNm,
        /** 그룹 정렬값 (prdGrpForm1.prdGrpOrd, 원본 문자열 유지) */
        String prdGrpOrd,
    ...
    public record Product(
            ...
            Long id,
            /** 제품명 (productDataForm.productNm) */
            String productNm,
            /** 제품 설명 (productDataForm.prdSubDesc) */
            String prdSubDesc,
            /** 수상 코드값 (productDataForm.awards, 값 있으면 FE에서 배지 노출) */
            String awards,
            /** 대표 이미지 URL (info.image, 미입력 시 null) */
            String image,
