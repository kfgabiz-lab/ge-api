 ...
 * ※ JSONB 컬럼(selectedProducts/jobTitles/studentInvolvement/vfdUnderstandingTopics)은 PageData/HeroData 와
 *   동일하게 hypersistence-utils 의 @Type + String 방식으로 매핑하되, PostgreSQL jsonb 컬럼에 JPA 로 직접
...
public class TrainingRequest {
    ...
    /** 수강자 직무 JSON 배열(VFD 조건부 질문, 선택) */
    @Type(JsonBinaryType.class)
    @Column(name = "job_titles", columnDefinition = "jsonb")
    private String jobTitles;

    /** 수강자 업무 관여도 JSON 배열(VFD 조건부 질문, 선택) */
    @Type(JsonBinaryType.class)
    @Column(name = "student_involvement", columnDefinition = "jsonb")
    ...
    /** VFD 이해 희망 주제 JSON 배열(선택) */
    @Type(JsonBinaryType.class)
    @Column(name = "vfd_understanding_topics", columnDefinition = "jsonb")
    private String vfdUnderstandingTopics;
    ...
    public TrainingRequest(String trainingTrack, String firstName, String lastName, String company,
                           ...
                           String selectedProducts, String jobTitles, String studentInvolvement,
                           String vfdUnderstanding, String vfdUnderstandingTopics, String comments,
